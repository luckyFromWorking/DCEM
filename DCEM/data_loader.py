...
class MMDataset(Dataset):
    ...
    def __init_mosi(self):
        ...
        # print('self.vision.shape', self.vision.shape)
        self.audio = data[self.mode]['audio'].astype(np.float32)
        # print('self.audio.shape', self.audio.shape)
        self.raw_text = data[self.mode]['raw_text']
        # print('self.raw_text.shape', self.raw_text.shape)
...
def MMDataLoader1(args, num_workers):
